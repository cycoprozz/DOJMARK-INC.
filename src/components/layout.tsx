        ...
        <nav className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <Link href="/" className="-m-1.5 p-1.5 flex items-center">
              ...
              />
              <span className="text-2xl font-bold text-gray-900 hidden sm:block">DOJMARK</span>
            </Link>
          </div>
      ...
      <footer className="bg-gray-900 border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
          <div className="flex justify-center space-x-6 md:order-2">
            ...
            <a href="https://www.instagram.com/cycoprozz?igsh=dGhyZG8xNzkwdjE5&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-600">
          ...
          <div className="mt-8 md:order-1 md:mt-0">
            <p className="text-center text-xs leading-5 text-gray-500">
              &copy; 2023 DOJMARK. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
